...
data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:10b}] set from entity @s Inventory[{Slot:10b}]
execute unless data entity @s Inventory[{Slot:10b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:10b}] set value {"Slot":10b,"count":0,"id":"minecraft:air"}

data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:11b}] set from entity @s Inventory[{Slot:11b}]
execute unless data entity @s Inventory[{Slot:11b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:11b}] set value {"Slot":11b,"count":0,"id":"minecraft:air"}

data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:12b}] set from entity @s Inventory[{Slot:12b}]
execute unless data entity @s Inventory[{Slot:12b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:12b}] set value {"Slot":12b,"count":0,"id":"minecraft:air"}

data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:13b}] set from entity @s Inventory[{Slot:13b}]
execute unless data entity @s Inventory[{Slot:13b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:13b}] set value {"Slot":13b,"count":0,"id":"minecraft:air"}

data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:14b}] set from entity @s Inventory[{Slot:14b}]
execute unless data entity @s Inventory[{Slot:14b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:14b}] set value {"Slot":14b,"count":0,"id":"minecraft:air"}

data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:15b}] set from entity @s Inventory[{Slot:15b}]
execute unless data entity @s Inventory[{Slot:15b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:15b}] set value {"Slot":15b,"count":0,"id":"minecraft:air"}

data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:16b}] set from entity @s Inventory[{Slot:16b}]
execute unless data entity @s Inventory[{Slot:16b}] run data modify entity @n[tag=backpacks.armor_stand] HandItems[0].components."minecraft:custom_data"."backpacks.backpack.storage"[{Slot:16b}] set value {"Slot":16b,"count":0,"id":"minecraft:air"}
